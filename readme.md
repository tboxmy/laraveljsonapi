## About Simple Laravel JSON API Server
...
This application is open-sourced software licensed under the [GNU General Public License v3.0](https://github.com/tboxmy/laraveljsonapi/blob/master/LICENSE).
